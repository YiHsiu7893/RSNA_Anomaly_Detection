...
import bigan.mnist as data
from utils.evaluations import do_prc, do_roc, score_distribution
    ...
    with sv.managed_session() as sess:
        ...
        if nb_epochs!=0:
            ...
            for t in range(nr_batches_test):
                ...
                original_images = testx[ran_from:ran_to]

                feed_dict = {input_pl: original_images, is_training_pl:False}
            ...
            fill = np.ones([batch_size - size, 64, 64, 1])
            ...
            roc_auc = do_roc(scores, testy,
                file_name=r'bigan/mnist/{}/{}/{}'.format(method, weight,
                                                        label),
                directory=r'results/bigan/mnist/{}/{}/'.format(method,
                                                            weight))

            score_distribution(scores, testy,
                file_name=r'bigan/mnist/{}/{}/{}'.format(method, weight,
                                                        label),
                directory=r'results/bigan/mnist/{}/{}/'.format(method,
                                                            weight))

            print("Testing | PRC AUC = {:.4f} | ROC = {:.4f}".format(prc_auc, roc_auc))
...
def open_img(filepath, target_size=(64, 64)):
    # 讀取DICOM圖像
