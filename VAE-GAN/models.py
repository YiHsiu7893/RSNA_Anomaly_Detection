...
class Encoder(nn.Module):
  def __init__(self):
    ...
    self.fc1=nn.Linear(256*8*8,2048) #8*8*256
...
class Decoder(nn.Module):
  def __init__(self):
    ...
    self.fc1=nn.Linear(128,8*8*256) #8*8*256
    self.bn1=nn.BatchNorm1d(8*8*256,momentum=0.9) #8*8*256
    self.relu=nn.LeakyReLU(0.2)
...
class Discriminator(nn.Module):
  def __init__(self):
    ...
    self.bn3=nn.BatchNorm2d(256,momentum=0.9)
    self.fc1=nn.Linear(8*8*256,512) #8*8*256
